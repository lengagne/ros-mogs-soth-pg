...
EIGEN_STRONG_INLINE
Matrix (const Scalar & v0, const Scalar & v1, const Scalar & v2,
...
void
set (const Scalar & v0, const Scalar & v1, const Scalar & v2)
{
	Base::_check_template_params ();
...
void
set (const Scalar & m00, const Scalar & m01, const Scalar & m02,
     const Scalar & m10, const Scalar & m11, const Scalar & m12,
     const Scalar & m20, const Scalar & m21, const Scalar & m22)
{
	Base::_check_template_params ();
