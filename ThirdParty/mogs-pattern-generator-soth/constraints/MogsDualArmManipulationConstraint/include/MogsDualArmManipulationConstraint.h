//      MogsDualArmManipulationConstraint.h
...
#ifndef __MOGSDualArmManipulationConstraint__
#define __MOGSDualArmManipulationConstraint__

#include "MogsKinematics.h"
#include "MogsAbstractSothConstraint.h"


class MogsDualArmManipulationConstraint: public MogsAbstractSothConstraint
{
      public:

        MogsDualArmManipulationConstraint(  unsigned int body1,
                                            unsigned int body2,
