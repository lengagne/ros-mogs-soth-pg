...
#ifndef __MogsMinimizeQConstraint__
#define __MogsMinimizeQrConstraint__
...
*/
class MogsMinimizeQConstraint: public MogsAbstractSothConstraint
{
      public:      
	      
	MogsMinimizeQConstraint(RigidBodyDynamics::MogsRobotProperties * robot);
	
	~MogsMinimizeQConstraint();
